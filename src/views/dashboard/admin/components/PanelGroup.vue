    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="panelGroupValue.sys_user_count"
            :duration="2000"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="panelGroupValue.sys_login_count"
            :duration="2200"
            class="card-panel-num"
          />
        </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="panelGroupValue.k8s_node_count"
            :duration="2400"
            class="card-panel-num"
          />
        </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to
            :start-val="0"
            :end-val="panelGroupValue.k8s_pod_count"
            :duration="2800"
            class="card-panel-num"
          />
        </div>
